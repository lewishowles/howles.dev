<template>
	<div class="relative flex flex-col items-start gap-3 bg-linear-to-b from-grey-100 to-white px-12 py-10 lg:rounded-2xl lg:bg-linear-to-br lg:from-pink-700 lg:to-purple-800 lg:text-lg lg:text-white dark:max-lg:from-white/5 dark:max-lg:to-transparent" data-test="welcome-part-deux">
