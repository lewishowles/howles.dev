<template>
	<bento-box
		class="group hocus:bg-linear-to-b hocus:from-white hocus:to-grey-100 focus-visible:ring-primary-600 dark:bg-grey-950/20 dark:hocus:bg-grey-950/30 dark:hocus:bg-none flex cursor-pointer items-center gap-4 py-6 transition-colors focus-visible:ring-2"
		tabindex="0"
