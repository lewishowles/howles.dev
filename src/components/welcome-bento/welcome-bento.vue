<template>
	<div class="welcome-bento w-full max-w-7xl grid-cols-3 gap-6 lg:grid" data-test="welcome-bento">
		<div class="col-start-1 row-span-3 flex flex-col gap-3 text-balance rounded-2xl bg-gradient-to-b from-grey-50 to-white px-12 py-10 md:bg-gradient-to-br md:from-pink-700 md:to-purple-800 md:text-lg md:text-white dark:max-md:bg-none">
			<p class="font-bold">
				Hi, I’m Lewis  👋
			</p>
		...
		<template v-if="includeUiExamples">
			...
			<div class="col-start-2 row-span-3 bg-grey-100">
				Preferences
			</div>
			<div class="col-start-1 row-span-4 bg-grey-100">
				Staff duties
			</div>
			<div class="col-start-3 bg-grey-100">
				Users
			</div>
		</template>

		<div class="relative col-span-2 col-start-2 row-span-4 mt-3 gap-3 bg-gradient-to-b from-grey-50 to-white px-12 py-10 md:mt-0 md:rounded-2xl md:bg-gradient-to-br md:from-pink-700 md:to-purple-800 md:text-lg md:text-white dark:max-md:from-white/5 dark:max-md:to-transparent">
			...
			<p class="mb-6">
				I’m enthusiastic about improving the user’s experience, the developer’s experience, and making websites and apps that are not only beautiful and powerful, but also <strong>easy to use</strong> and <strong>accessible</strong>. My passion for inclusive design fuels my drive to craft delightful user experiences.
			</p>
			...
			<ul class="inset-well mt-10 flex flex-wrap gap-3 rounded-2xl bg-gradient-to-br from-pink-50 to-purple-50 text-xs text-purple-800 md:gap-5 md:bg-grey-950/20 md:bg-none md:text-sm md:text-white dark:bg-grey-950/20 dark:bg-none dark:max-md:text-grey-200">
				<li class="rounded-full border border-current px-[1em] py-[0.5em]">
					UI design
				</li>
				<li class="rounded-full border border-current px-[1em] py-[0.5em]">
		...
		<div v-if="includeUiExamples" class="col-start-1 row-span-2 bg-grey-100">
			Team access
		</div>
	</div>
</template>
